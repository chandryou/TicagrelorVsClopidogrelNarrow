...
OhdsiRTools::checkUsagePackage("TicagrelorVsClopidogrelNarrow")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/TicagrelorVsClopidogrelNarrow.pdf")
shell("R CMD Rd2pdf ./ --output=extras/TicagrelorVsClopidogrelNarrow.pdf")
...
OhdsiRTools::insertCohortDefinitionSetInPackage(fileName = "CohortsToCreate.csv",
                                                ...
                                                generateStats = FALSE,
                                                packageName = "TicagrelorVsClopidogrelNarrow")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("TicagrelorVsClopidogrelNarrow")
