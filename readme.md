...
2. In 'R', use the following code to install the TicagrelorVsClopidogrelNarrow package:
...
3. Once installed, you can execute the study by modifying and using the following code:
	...
	```r
	library(TicagrelorVsClopidogrelNarrow)
	...
	outputFolder <- "c:/TicagrelorVsClopidogrelNarrow"
...
License
=======
The TicagrelorVsClopidogrelNarrow package is licensed under Apache License 2.0


Development
===========
TicagrelorVsClopidogrelNarrow was developed in ATLAS and R Studio.
